...
const CertifierHome: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const certifierNotifications = allNotifications.filter((notif: Notification) => 
      notif.toRole === 'certifier' && notif.toName === user?.fullName
    );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-purple-50/30 to-violet-50/30 dark:from-background dark:via-purple-900/10 dark:to-violet-900/10">
      {/* Header */}
      <header className="bg-background/80 backdrop-blur-sm border-b border-border shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 gradient-certifier rounded-lg flex items-center justify-center">
                <Award className="w-5 h-5 text-white" />
              </div>
              <h1 className="text-xl font-bold text-foreground">SkillBridge Certifier Panel</h1>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-right">
                ...
                <p className="text-xs text-muted-foreground">Certifier</p>
              </div>
              <button
                onClick={logout}
